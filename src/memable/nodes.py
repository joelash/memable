...
from memable.retrieval import build_memory_context, retrieve_memories
from memable.store import SemanticMemoryStore
...
def consolidate_memories_node(
    ...
    *,
    ...
    """
    from memable.consolidation import consolidate_memories
